...
i = 2
plot(d.green.500.g[[i]]$A0, post.500[[i]]$BUGSoutput$median$A, xlim = c(6, 16),
...
i = 3
plot(d.green.500.g[[i]]$A0, post.500[[i]]$BUGSoutput$median$A, xlim = c(2, 11),
     ylim = c(3.4, 4), xlab = "A0", ylab = "A", pch = 21, cex = 2, bg = cols[1],
     main = gen[i])
points(d.green.1k.g[[i]]$A0, post.1k[[i]]$BUGSoutput$median$A, pch = 21, 
       cex = 2, bg = cols[2])
abline(0, 1)
